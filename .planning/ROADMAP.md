...
- [x] 02-01-PLAN.md — Create the shared canonical fixture and JS snapshot harness
- [x] 02-02-PLAN.md — Add Python parity checks against the shared fixture and JS harness
